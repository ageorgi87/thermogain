...
import { HousingFields } from "@/app/(main)/projects/[projectId]/logement/components/HousingFields"
import { saveHousingData } from "@/app/(main)/projects/[projectId]/logement/actions/saveHousingData"
import { housingSchema, type HousingData } from "@/app/(main)/projects/[projectId]/logement/actions/housingSchema"
import { updateProjectStep } from "@/lib/actions/projects/updateProjectStep"
import { WIZARD_STEPS } from "@/lib/wizard/wizardStepsData"

interface LogementStepClientProps {
  projectId: string
...
export const LogementStepClient = ({
  projectId,
  initialData,
  currentStepNumber,
}: LogementStepClientProps) => {
  const router = useRouter()
  const [formData, setFormData] = useState<Partial<HousingData>>(initialData)
