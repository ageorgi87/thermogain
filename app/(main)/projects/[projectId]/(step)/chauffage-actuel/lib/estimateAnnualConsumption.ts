import { getConsumptionCoefficient } from "@/app/(main)/projects/[projectId]/(step)/chauffage-actuel/lib/getConsumptionCoefficient";
import { getOccupancyFactor } from "@/app/(main)/projects/[projectId]/(step)/chauffage-actuel/lib/getOccupancyFactor";
