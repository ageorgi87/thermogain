...
import { estimateConsumptionByEnergyType } from "@/app/(main)/projects/[projectId]/(step)/chauffage-actuel/lib/estimateConsumptionByEnergyType";
import { getCachedEnergyPrice } from "@/lib/energy/priceCache/getCachedEnergyPrice";
import { GAS_SUBSCRIPTION } from "@/config/constants";
import { adjustConsumptionForEfficiency } from "@/app/(main)/projects/[projectId]/(step)/chauffage-actuel/lib/adjustConsumptionForEfficiency";
