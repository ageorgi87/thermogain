...
/**
 * Calcule les aides pour une PAC Air/Air via l'API Mes Aides Réno
 *
 * Cette fonction :
 ...
 */
export const calculateAidesAirAir = async (
  projectData: ProjectDataForAides
): Promise<CalculateAidesResult> => {
  try {
    // Field name pour PAC air-air
    const fieldName = "gestes.chauffage.PAC.air-air.montant";
    ...
    console.error("❌ Erreur lors du calcul des aides PAC Air/Air:", error);
