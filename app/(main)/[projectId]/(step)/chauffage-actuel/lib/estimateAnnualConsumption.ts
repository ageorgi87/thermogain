import { getConsumptionCoefficient } from "@/app/(main)/[projectId]/(step)/chauffage-actuel/lib/getConsumptionCoefficient";
import { getOccupancyFactor } from "@/app/(main)/[projectId]/(step)/chauffage-actuel/lib/getOccupancyFactor";
import { getConsumptionAdjustment } from "@/lib/climate/getConsumptionAdjustment";
import type { HousingCharacteristics } from "@/app/(main)/[projectId]/(step)/chauffage-actuel/types/housingCharacteristics"
