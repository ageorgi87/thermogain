...
import { CurrentHeatingData } from "@/app/(main)/[projectId]/(step)/chauffage-actuel/actions/currentHeatingSchema"
...
import { PriceLabelWithTooltip } from "@/app/(main)/[projectId]/(step)/chauffage-actuel/components/PriceLabelWithTooltip"
