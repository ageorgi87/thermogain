...
export async function sendStudyResults({
  ...
  try {
    ...
    const projectData: ProjectData = {
      ...
      puissance_souscrite_actuelle: project.chauffageActuel?.puissance_souscrite_actuelle || undefined,
      ...
      // Aides
      reste_a_charge: (project.couts?.cout_total || 0) - (project.aides?.total_aides || 0),
      ...
      evolution_prix_electricite: project.evolutions?.evolution_prix_electricite || undefined,
    ...
    const professionalName = project.user.firstName && project.user.lastName
