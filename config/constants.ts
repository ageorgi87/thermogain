...
// ============================================================================
// 11. CONSOMMATION ÉNERGÉTIQUE PAR CLASSE DPE
// ============================================================================

import { ClasseDPE } from "@/types/dpe";

/**
 * Consommation énergétique moyenne par m² selon la classe DPE
 * Exprimée en kWh/m²/an (énergie primaire)
 *
 * Source: Réglementation DPE 2021 (Arrêté du 31 mars 2021)
 * URL: https://www.legifrance.gouv.fr/jorf/id/JORFTEXT000043326829
 * Utilisé dans: Calcul des besoins énergétiques théoriques basés sur DPE
 * Dernière mise à jour: Décembre 2024
 *
 * Note: Les valeurs correspondent aux seuils MAXIMUMS de chaque classe
 * Pour le calcul, on utilise la valeur médiane de chaque classe
 */
export const DPE_ENERGY_CONSUMPTION_KWH_M2: Record<ClasseDPE, number> = {
  /**
   * Classe A: ≤ 70 kWh/m²/an
   * Logement très performant (BBC, RT2012+)
   * Valeur médiane utilisée: 50 kWh/m²/an
   */
  [ClasseDPE.A]: 50,
   ...
   * Valeur médiane: 215 kWh/m²/an
   */
  [ClasseDPE.D]: 215,

  /**
   * Classe E: 251 à 330 kWh/m²/an
   * Logement peu performant (passoires thermiques)
   * Valeur médiane: 290 kWh/m²/an
   */
  [ClasseDPE.E]: 290,

  /**
   * Classe F: 331 à 420 kWh/m²/an
   * Logement très peu performant (passoire thermique)
   * Valeur médiane: 375 kWh/m²/an
   */
  [ClasseDPE.F]: 375,

  /**
   * Classe G: > 420 kWh/m²/an
   * Logement extrêmement énergivore (passoire thermique)
   * Valeur utilisée: 500 kWh/m²/an (estimation conservatrice)
   */
  [ClasseDPE.G]: 500,
}
